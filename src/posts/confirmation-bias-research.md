---
title: "Why \"Doing Your Own Research\" Usually Means Confirming What You Already Felt"
seoTitle: "Confirmation Bias: Why Your Own Research Keeps Agreeing With You"
...
faq:
  - q: "What is confirmation bias in simple terms?"
    a: "Confirmation bias is the tendency to search for, notice, and remember information that supports what you already believe, while skimming past or discounting information that doesn't. It's not a character flaw — it's the default setting of human attention, and it runs whether or not you know about it."
  - q: "Does knowing about confirmation bias stop it?"
    a: "Not by itself. Awareness helps a little, but the bias operates upstream of awareness — in which search terms you type and which results you click. The reliable fix is structural: deliberately search for the disconfirming version of your question before you decide."
  - q: "Is confirmation bias the same as motivated reasoning?"
    a: "They're cousins. Confirmation bias can happen with no emotional stake at all — it's a testing-strategy problem. Motivated reasoning is when you also *want* a particular answer, so you hold unwelcome evidence to a much stricter standard. Real-world research sessions usually involve both at once."
  - q: "How do I research a purchase without confirmation bias?"
...
## Why does your research keep agreeing with you?
...
## Why doesn't the negative review change your mind?
...
- **Write down your lean first.** One sentence, before you open a single tab: "I'm currently at about 70% yes." If you can't admit you have a lean, the lean is driving.
- **Run the negative search before the positive one.** The product name plus "problems," "refund," "quit," or "regret." Make the strongest case against it your starting point, not a box you check at the end.
- **Notice who profits from the page you're reading.** A "review" with a discount code in it is a sales page wearing reading glasses.
- **Find the smartest critic, not the dumbest one.** Dismissing a lazy one-star review proves nothing. If you can answer the *best* objection you found, your confidence earned its keep.
- **Count sources, not tabs.** Ten articles citing the same study is one source. Ask where the claim originally comes from; if you can't find out, weigh it accordingly.
- **Apply the flip test.** Ask: if this exact evidence pointed the other way, would I accept it? If the answer is no, you're not evaluating evidence. You're defending a verdict.
...
- **Confirmation bias is pervasive across domains and operates in how people seek, interpret, and recall evidence.** — Raymond S. Nickerson, "Confirmation Bias: A Ubiquitous Phenomenon in Many Guises," *Review of General Psychology*, 1998. [https://doi.org/10.1037/1089-2680.2.2.175](https://doi.org/10.1037/1089-2680.2.2.175)
- **When testing their own hypotheses, people overwhelmingly seek confirming instances rather than the test that could disprove them.** — Peter C. Wason, "On the Failure to Eliminate Hypotheses in a Conceptual Task," *Quarterly Journal of Experimental Psychology*, 1960. [https://doi.org/10.1080/17470216008416717](https://doi.org/10.1080/17470216008416717)
- **People rate evidence supporting their existing position as stronger and better conducted than identical-quality evidence against it ("biased assimilation").** — Lord, Ross & Lepper, "Biased Assimilation and Attitude Polarization: The Effects of Prior Theories on Subsequently Considered Evidence," *Journal of Personality and Social Psychology*, 1979. [https://doi.org/10.1037/0022-3514.37.11.2098](https://doi.org/10.1037/0022-3514.37.11.2098)
- **In real search-engine behavior, people phrase health queries in belief-confirming terms and disproportionately click confirming results — and engines themselves favor a usually-positive perspective regardless of the truth.** — Ryen W. White, "Beliefs and Biases in Web Search," *Proceedings of SIGIR '13*, Microsoft Research, 2013. [https://doi.org/10.1145/2484028.2484053](https://doi.org/10.1145/2484028.2484053)
- **Wanting a particular conclusion leads people to apply stricter standards to unwelcome evidence than to welcome evidence.** — Ziva Kunda, "The Case for Motivated Reasoning," *Psychological Bulletin*, 1990. [https://doi.org/10.1037/0033-2909.108.3.480](https://doi.org/10.1037/0033-2909.108.3.480)
- **Repeated statements feel truer than new ones, and prior knowledge does not fully protect against the effect.** — Fazio, Brashier, Payne & Marsh, "Knowledge Does Not Protect Against Illusory Truth," *Journal of Experimental Psychology: General*, 2015. [https://doi.org/10.1037/xge0000098](https://doi.org/10.1037/xge0000098)
